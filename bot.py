...
bot = commands.AutoShardedBot(command_prefix=bot_triggers, description="A bot with several purposes, like music, memes, weather, but based off of the furry fandom.", pm_help=True)
