...
async def stats():
    ...
    sumupmembers = int(str(sethsfollowers)) * int(shard_count)
    sumupuni = int(str(uniqueonline)) * int(shard_count)
    ...
    em.add_field(name='Members', value=sumupmembers + "/" + sumupuni, inline=True)
