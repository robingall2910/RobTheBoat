...
bot = commands.AutoShardedBot(command_prefix=commands.when_mentioned_or(bot_triggers), description="A bot with several purposes, like music, memes, weather, but based off of the furry fandom.")
