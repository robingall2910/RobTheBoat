...
def finalize_logging():
    if os.path.isfile("logs/rtb.log"):
        ...
        try:
            ...
            os.rename("logs/rtb.log", "logs/rtb.log.last")
        except:
            pass

    with open("logs/rtb.log", 'w', encoding='utf8') as f:
        tmpfile.seek(0)
    ...
    fh = logging.FileHandler("logs/rtb.log", mode='a')
...
def req_ensure_env():
    ...
    try:
        ...
        assert os.path.isdir('rtb'), 'folder "rtb" not found'
